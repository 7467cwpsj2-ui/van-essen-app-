    ...
    <form ref={formRef} action={submit} className="add-form">
      ...
      {done && (
        <div className="hint-bar small">
          Uitnodigingsmail is verstuurd. Komt die niet aan? Klap het teamlid hieronder in de lijst uit — daar staat altijd een
          knop om zelf een link aan te maken en handmatig door te sturen (bijv. via WhatsApp).
        </div>
      )}
    </form>
  );
